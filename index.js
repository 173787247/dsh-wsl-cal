import { calStatus, khalList, khalAgenda } from "./lib/cal.js";
...
export function apply(ctx, config = {}) {
  ...
  ctx.systemPrompt.section({
    name: "tool:cal",
    order: 140,
    text: "dsh-wsl-cal lists events via khal (read-only). Configure khal calendars yourself. Does not create/modify events.",
  });

  ctx.tools.register({
    name: "cal_status",
    description: "Whether khal is on PATH.",
